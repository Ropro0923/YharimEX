                        ...
                        if (counter == maxTime)
                        {
                            if (YharimEXGlobalUtilities.HostCheck)
                            {
                                for (int j = 0; j < 4; j++)
                                {
                                    ...
                                    Projectile.NewProjectile(Terraria.Entity.InheritSource(Projectile), Projectile.Center, speed, ModContent.ProjectileType<YharimEXCelestialFragment>(), Projectile.damage, 0f, Main.myPlayer, Projectile.ai[1]);
                                }
                            }
                        }
                    }
