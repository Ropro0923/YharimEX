...
{
    public class YharimEXHolyRay : ModProjectile
    {
        [CompilerGenerated]
        ...
        public override void AI()
        {
            ...
            if (((Entity)Main.npc[(int)Projectile.ai[1]]).active && Main.npc[(int)Projectile.ai[1]].type == ModContent.NPCType<YharimEXBoss>())
            {
