...
{
    public abstract class YharimEXBaseDeathray : ModProjectile
    {
        ...
        protected YharimEXBaseDeathray(float maxTime, float transparency = 0f, float hitboxModifier = 1f, int drawDistance = 3000, int grazeCD = 15, TextureSheeting sheeting = TextureSheeting.Horizontal)
        {
        ...
        public override void SetDefaults() //MAKE SURE YOU CALL BASE.SETDEFAULTS IF OVERRIDING
        {
            ...
            if (YharimEXCrossmodSystem.FargowiltasSouls.Loaded)
            {
                ...
                SetupFargoProjectile.GrazeCheck3 = true;
            }
        ...
        public override void PostAI()
        {
            ...
            if (SetupFargoProjectile.GrazeCD > grazeCD)
                SetupFargoProjectile.GrazeCD = grazeCD;
        }
