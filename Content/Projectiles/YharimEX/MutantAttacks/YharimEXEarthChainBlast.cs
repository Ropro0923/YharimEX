...
{
    public class YharimEXEarthChainBlast : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            //if (++Projectile.ai[0] > Main.projFrames[Projectile.type] * 3) Projectile.Kill();
                ...
                if (++Projectile.localAI[1] == 8 && Projectile.ai[1] > 0 && YharimEXGlobalUtilities.HostCheck)
                {
                    Projectile.ai[1]--;
        ...
        public override void OnHitPlayer(Player target, Player.HurtInfo info)
        {
            ...
            if (YharimEXWorldFlags.EternityMode || YharimEXWorldFlags.DeathMode)
            {
                ...
                target.AddBuff(FargoSouls.Find<ModBuff>("LethargicBuff").Type, 300);
            }
        }
