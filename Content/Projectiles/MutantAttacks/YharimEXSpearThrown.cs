        ...
        public override void AI()
        {
            if (--Projectile.localAI[0] < 0)
            {
                ...
                else
                {
                    ...
                    if (Projectile.ai[1] == 0 && YharimEXUtilities.HostCheck)
            ...
            if (Projectile.localAI[1] == 0f)
            {
                ...
                SoundEngine.PlaySound((YharimEXWorldFlags.MasochistModeReal || YharimEXWorldFlags.InfernumMode) ? YharimEXSoundRegistry.YharimEXPenetratorExplosion : YharimEXSoundRegistry.YharimEXPenetratorThrow, Projectile.Center);
            }
