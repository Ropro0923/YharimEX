...
namespace YharimEX.Content.Projectiles.MutantAttacks
{
    public class YharimEXNuke : ModProjectile, IPixelatedPrimitiveRenderer
    {
        ...
        public override void SetDefaults()
        {
            ...
            Projectile.timeLeft = (YharimEXWorldFlags.MasochistModeReal || YharimEXWorldFlags.InfernumMode) ? 120 : 180;
            CooldownSlot = 1;
        ...
        {
            SoundEngine.PlaySound(YharimEXSoundRegistry.YharimEXNukeFishronExplosion with { Volume = 6}, Projectile.Center);
            int num1 = 36;
        ...
        public void RenderPixelatedPrimitives(SpriteBatch spriteBatch)
        {
            ...
            YharimEXUtilities.SetTexture1(YharimEXTextureRegistry.ColorNoiseMap.Value);
