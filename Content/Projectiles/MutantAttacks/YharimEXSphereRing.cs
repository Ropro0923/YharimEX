...
namespace YharimEX.Content.Projectiles.MutantAttacks
{
    public class YharimEXSphereRing : ModProjectile
    {
        ...
        public override void SetDefaults()
        {
            ...
            if (Projectile.type == ModContent.ProjectileType<YharimEXSphereRing>())
            {
                ...
                if (YharimEXCrossmodSystem.FargowiltasSouls.Loaded)
                {
                    ...
                    SetupFargoProjectile.TimeFreezeImmune = (YharimEXWorldFlags.MasochistModeReal || YharimEXWorldFlags.InfernumMode)
                    && YharimEXUtilities.BossIsAlive(ref YharimEXGlobalNPC.yharimEXBoss, ModContent.NPCType<YharimEXBoss>())
        ...
        {
            return target.hurtCooldowns[1] == 0 || YharimEXWorldFlags.MasochistModeReal || YharimEXWorldFlags.InfernumMode;
        }
        ...
        public override void AI()
        {
            ...
            if (DieOutsideArena)
            {
                ...
                Projectile ritual = YharimEXUtilities.ProjectileExists(ritualID, ModContent.ProjectileType<YharimEXRitual>());
        ...
        void TryTimeStop()
        {
                ...
                && YharimEXUtilities.BossIsAlive(ref YharimEXGlobalNPC.yharimEXBoss, ModContent.NPCType<YharimEXBoss>()))
            {
                ...
                if ((YharimEXWorldFlags.MasochistModeReal || YharimEXWorldFlags.InfernumMode) && Main.npc[YharimEXGlobalNPC.yharimEXBoss].ai[0] == -5
                    && Projectile.Colliding(Projectile.Hitbox, Main.LocalPlayer.YharimPlayer().GetPrecisionHurtbox()))
                {
