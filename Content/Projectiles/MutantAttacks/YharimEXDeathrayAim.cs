...
{
	public class YharimEXDeathrayAim : YharimEXBaseDeathray, IPixelatedPrimitiveRenderer
    {
        public override string Texture => "YharimEX/Content/Projectiles/MutantAttacks/PhantasmalDeathrayML";
        ...
        public override void AI()
        {
            ...
            if (npc != null && !npc.dontTakeDamage && !(YharimEXWorldFlags.MasochistModeReal || YharimEXWorldFlags.InfernumMode))
            {
        ...
        {
            Color color = Color.Red;//Color.Lerp(new(31, 187, 192), new(51, 255, 191), trailInterpolant) * Projectile.Opacity;
            color.A = 100;
            return color;
        }
