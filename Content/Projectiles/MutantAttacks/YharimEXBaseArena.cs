...
{
    public abstract class YharimEXBaseArena : ModProjectile
    {
        ...
        protected YharimEXBaseArena(float rotationPerTick, float threshold, int npcType, int dustType = 135, int increment = 2, int visualCount = 32)
        {
        ...
        public override void SetDefaults() //MAKE SURE YOU CALL BASE.SETDEFAULTS IF OVERRIDING
        {
            ...
            if (YharimEXCrossmodSystem.FargowiltasSouls.Loaded)
            {
                ...
                SetupFargoProjectile.GrazeTargetPlayer = targetPlayer;
                SetupFargoProjectile.GrazeThreshold = threshold;
            }
        }
