    ...
    public class YharimEXDestroyerBody : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            Texture2D texture2D13 = Projectile.ai[2] == 0
                ...
                : ModContent.Request<Texture2D>("Terraria/Images/NPC_14", AssetRequestMode.ImmediateLoad).Value;
        ...
        public override void AI()
        {
            ...
            int byIdentity = YharimEXUtilities.GetProjectileByIdentity(Projectile.owner, (int)Projectile.ai[0], Projectile.type, ModContent.ProjectileType<YharimEXDestroyerHead>());
            if (byIdentity >= 0 && Main.projectile[byIdentity].active)
            {
                ...
                if (Main.projectile[byIdentity].type != ModContent.ProjectileType<YharimEXDestroyerHead>()) Main.projectile[byIdentity].localAI[1] = Projectile.identity;
