...
{
    public class YharimEXGolemHead : ModProjectile
    {
        public override string Texture => "YharimEX/Assets/Projectiles/YharimEXGolemHead";
            ...
            if (--Projectile.ai[0] == 0)
            {
                ...
                if (YharimEXUtilities.HostCheck)
                {
                    Projectile.NewProjectile(Projectile.GetSource_FromThis(), Projectile.Center,
                        ...
                        ModContent.ProjectileType<YharimEXGolemBeam>(),
