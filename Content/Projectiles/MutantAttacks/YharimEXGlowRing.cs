...
{
    public class YharimEXGlowRing : ModProjectile
    {
        public override string Texture => "YharimEX/Assets/Projectiles/YharimEXGlow";
        ...
        public override void AI()
        {
            ...
            NPC npc = YharimEXUtilities.NPCExists(Projectile.ai[0]);
            if (npc != null)
