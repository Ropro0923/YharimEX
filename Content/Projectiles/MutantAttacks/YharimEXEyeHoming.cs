...
namespace YharimEX.Content.Projectiles.MutantAttacks
{
    public class YharimEXEyeHoming : YharimEXEye
    {
        ...
        public override void AI()
        {
            ...
            NPC npc = YharimEXUtilities.NPCExists(YharimEXGlobalNPC.yharimEXBoss, ModContent.NPCType<YharimEXBoss>());
            ...
            Player p = YharimEXUtilities.PlayerExists(npc == null ? Projectile.ai[0] : npc.target);
