...
{
	public class YharimEXDeathraySmall : YharimEXBaseDeathray, IPixelatedPrimitiveRenderer
    {
        ...
        public override void AI()
        {
            ...
            if (Projectile.localAI[0] >= maxTime || YharimEXWorldFlags.MasochistModeReal || YharimEXWorldFlags.InfernumMode)
            {
                Projectile.Kill();
                return;
            }
