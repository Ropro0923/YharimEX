...
namespace YharimEX.Content.Projectiles.MutantAttacks
{
    public class YharimEXTrueEyeR : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D pupil = ModContent.Request<Texture2D>("YharimEX/Content/Projectiles/MutantAttacks/YharimEXTrueEyePupil", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value;
