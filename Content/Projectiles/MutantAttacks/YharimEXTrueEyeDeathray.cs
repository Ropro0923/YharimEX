...
{
	public class YharimEXTrueEyeDeathray : YharimEXBaseDeathray, IPixelatedPrimitiveRenderer
    {

        public override string Texture => "YharimEX/Content/Projectiles/MutantAttacks/PhantasmalDeathray";
        public YharimEXTrueEyeDeathray() : base(90) { }
        ...
        public void RenderPixelatedPrimitives(SpriteBatch spriteBatch)
        {
            ...
            shader.TrySetParameter("mainColor", new Color(253, 252, 183, 100));
