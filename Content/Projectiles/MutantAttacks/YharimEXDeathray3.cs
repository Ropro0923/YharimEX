...
{
	public class YharimEXDeathray3 : YharimEXBaseDeathray, IPixelatedPrimitiveRenderer
    {

        public override string Texture => "YharimEX/Content/Projectiles/MutantAttacks/PhantasmalDeathray";
        ...
        public override void AI()
        {
            ...
            float DECELERATION = (YharimEXWorldFlags.MasochistModeReal || YharimEXWorldFlags.InfernumMode) ? 0.9716f : 0.9712f;
