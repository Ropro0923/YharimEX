...
namespace YharimEX.Content.Projectiles.MutantAttacks
{
    public class YharimEXTrueEyeSphere : ModProjectile
    {
        ...
        {
            int byIdentity = YharimEXUtilities.GetProjectileByIdentity(Projectile.owner, (int)Projectile.ai[0], ModContent.ProjectileType<YharimEXTrueEyeR>());
            if (byIdentity != -1)
            {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Color glowcolor = Color.Lerp(Color.Cyan, Color.Transparent, 0.85f);
