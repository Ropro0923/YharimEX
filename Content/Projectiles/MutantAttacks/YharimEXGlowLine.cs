        ...
        public override void AI()
        {
                ...
                case 0: //abom flaming scythe telegraph, sticks to abom and follows his line of sight to player w/ offset
                    {
                        ...
                        NPC abom = YharimEXUtilities.NPCExists(Projectile.localAI[1], ModContent.NPCType<YharimEXBoss>());
                        if (abom != null)
                        {
                        ...
                        if (YharimEXCrossmodSystem.FargowiltasSouls.Loaded)
            {
                ...
                SetupFargoProjectile.TimeFreezeImmune = true;
                        ...
                        Player p = YharimEXUtilities.PlayerExists(Projectile.ai[1]);
                        if (p != null)
                        {
...
/*
            ...
            /*    case 11: //destroyer telegraphs
                    {
                        ...
                        NPC npc = YharimEXGlobalUtilities.NPCExists(Projectile.ai[1], NPCID.TheDestroyerBody, NPCID.TheDestroyerTail);
                        if (npc == null)
                        {
                            Projectile.Kill();
                            return;
                        ...
                        NPC destroyer = YharimEXGlobalUtilities.NPCExists(npc.realLife, NPCID.TheDestroyer);
                ...
                case 12: //wof vanilla laser telegraph
                    {
                        ...
                        NPC npc = YharimEXGlobalUtilities.NPCExists(Projectile.ai[1], NPCID.WallofFleshEye);
                ...
                case 13: //mutant final spark tell
                    {
                        ...
                        NPC mutant = YharimEXUtilities.NPCExists(Projectile.ai[1], ModContent.NPCType<YharimEXBoss>());
                        if (mutant != null)
                        {
            ...
            /*    case 14: //moon lord vortex telegraph
                    {
                        ...
                        Projectile vortex = YharimEXGlobalUtilities.ProjectileExists(YharimEXGlobalUtilities.GetProjectileByIdentity(Projectile.owner, Projectile.ai[1], ModContent.ProjectileType<MoonLordVortex>()));
                        if (vortex != null)
                        {
                ...
                case 17: //moon lord nebula distortion field
                    {
                        ...
                        else
                        {
                            ...
                            Projectile ritual = YharimEXGlobalUtilities.ProjectileExists(Projectile.localAI[1], ModContent.ProjectileType<LunarRitual>());
            ...
            */
                ...
                case 18: //cultist arena new visual
                    {
                        color = Color.OrangeRed * 0.75f;
                        maxTime = 60 * 2;
                        alphaModifier = 1;

                        NPC npc = YharimEXUtilities.NPCExists(Projectile.ai[1], NPCID.CultistBoss);
                        if (npc != null)
                        {
                            if (counter > maxTime / 2)
                                counter = maxTime / 2;
                            ...
                            if (npc.ai[0] == 5)
                            {
                                ...
                                if (counter > 0 && npc.ai[1] == 1f && YharimEXUtilities.HostCheck)
                                {
                                    Projectile.Kill();
                                    return;
                                }
