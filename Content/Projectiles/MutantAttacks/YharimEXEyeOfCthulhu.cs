...
namespace YharimEX.Content.Projectiles.MutantAttacks
{
    ...
    {
        public override string Texture => "CalamityMod/NPCs/CalClone/CalamitasClone";
        ...
        {
            Player player = YharimEXUtilities.PlayerExists(Projectile.ai[0]);
            if (player == null)
            {
                Projectile.Kill();
                return;
        ...
        public override void OnHitPlayer(Player target, Player.HurtInfo info)
        {
            ...
            if (YharimEXWorldFlags.EternityMode || YharimEXWorldFlags.DeathMode)
            {
                ...
                target.AddBuff(FargoSouls.Find<ModBuff>("BerserkedBuff").Type, 120);
