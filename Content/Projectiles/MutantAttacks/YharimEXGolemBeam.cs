...
{
    public class YharimEXGolemBeam : YharimEXBaseDeathray
    {
        public override string Texture => "YharimEX/Assets/Projectiles/YharimEXGolemBeam";
        public YharimEXGolemBeam() : base(420) { }
        ...
        public override void AI()
        {
            ...
            Projectile head = YharimEXGlobalUtilities.ProjectileExists(YharimEXGlobalUtilities.GetProjectileByIdentity(Projectile.owner, Projectile.ai[1]), ModContent.ProjectileType<YharimEXGolemHead>());
            if (head != null)
            {
        ...
        public override void OnHitPlayer(Player target, Player.HurtInfo info)
        {
            ...
            {
                target.AddBuff(FargoSouls.Find<ModBuff>("DefenselessBuff").Type, 300);
