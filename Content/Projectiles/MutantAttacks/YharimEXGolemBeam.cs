...
namespace YharimEX.Content.Projectiles.MutantAttacks
{
    public class YharimEXGolemBeam : YharimEXBaseDeathray
    {
        ...
        public override void AI()
        {
            ...
            Projectile head = YharimEXUtilities.ProjectileExists(YharimEXUtilities.GetProjectileByIdentity(Projectile.owner, Projectile.ai[1]), ModContent.ProjectileType<YharimEXGolemHead>());
            if (head != null)
            {
