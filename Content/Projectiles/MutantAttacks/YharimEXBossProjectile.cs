...
namespace YharimEX.Content.Projectiles.MutantAttacks
{
    public class YharimEXBossProjectile : ModProjectile
    {
        ...
        public static string trailTexture => "YharimEX/Assets/NPCs/Boss/YharimEXSoul";
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D aura = ModContent.Request<Texture2D>("YharimEX/Assets/NPCs/Boss/YharimEXAura", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value;
