...
namespace YharimEX.Content.Projectiles.MutantAttacks
{
    ...
    {
        public override string Texture => "YharimEX/Content/NPCs/YharimBoss/YharimEXBoss";
        public static string trailTexture => "YharimEX/Content/NPCs/YharimBoss/YharimEXSoul";
        ...
        public override void AI()
        {
            ...
            NPC npc = YharimEXUtilities.NPCExists(Projectile.ai[1], npcType);
            if (npc != null)
            {
                ...
                if (npc.ai[0] == 10 && (YharimEXWorldFlags.EternityMode || YharimEXWorldFlags.DeathMode))
                {
                    SHADOWMUTANTREAL += 0.03f;
                    if (SHADOWMUTANTREAL > 0.75f)
                        SHADOWMUTANTREAL = 0.75f;

                    if (npc.ai[1] > 150 && (YharimEXWorldFlags.MasochistModeReal || YharimEXWorldFlags.InfernumMode) && Main.getGoodWorld)
                        Cake = true;
                }
                ...
                if ((YharimEXWorldFlags.MasochistModeReal || YharimEXWorldFlags.InfernumMode) && (npc.ai[0] >= 11 || npc.ai[0] < 0))
                {
                    sansEye = true;
                    Projectile.ai[0] = -1;
                }
                ...
                if ((YharimEXWorldFlags.MasochistModeReal || YharimEXWorldFlags.InfernumMode) && Main.getGoodWorld)
                {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Texture2D aura = ModContent.Request<Texture2D>("YharimEX/Content/NPCs/YharimBoss/YharimEXAura", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value;
            ...
            //if (auraTrail && (YharimEXWorldFlags.MasochistModeReal || YharimEXWorldFlags.InfernumMode))
            //{
            //    Main.spriteBatch.End();
            ...
            if (sansEye)
            {
                ...
                bool forcedMasoEye = (YharimEXWorldFlags.MasochistModeReal || YharimEXWorldFlags.InfernumMode) && Projectile.ai[0] == -1;
                ...
                Texture2D star = ModContent.Request<Texture2D>("YharimEX/Assets/Projectiles/YharimEXLifeStar", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value;
