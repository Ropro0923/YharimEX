    ...
    public class YharimEXDestroyerTail : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            Texture2D texture2D13 = Projectile.ai[2] == 0
                ...
                : ModContent.Request<Texture2D>("Terraria/Images/NPC_15", AssetRequestMode.ImmediateLoad).Value;
        ...
        public override void AI()
        {
            ...
            int byIdentity = YharimEXUtilities.GetProjectileByIdentity(Projectile.owner, (int)Projectile.ai[0], ModContent.ProjectileType<YharimEXDestroyerBody>());
