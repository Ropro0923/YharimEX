...
namespace YharimEX.Content.Projectiles.DLCAttack
{
    public class DLCYharimFishronRitual : ModProjectile
    {
        ...
        {
            return Projectile.alpha == 0f && YharimEXUtilities.NPCExists(Projectile.ai[0], ModContent.NPCType<YharimEXBoss>()).GetGlobalNPC<CalDLCEmodeAttacks>().DLCAttackChoice == CalDLCEmodeAttacks.DLCAttack.AresNuke;
        }
