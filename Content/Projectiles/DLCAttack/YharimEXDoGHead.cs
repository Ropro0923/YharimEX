...
namespace YharimEX.Content.Projectiles.DLCAttack
{
    ...
    {
        public override string Texture => YharimEXCrossmodSystem.InfernumMode.Loaded? "InfernumMode/Content/BehaviorOverrides/BossAIs/DoG/DoGP2Head" : "CalamityMod/NPCs/DevourerofGods/DevourerofGodsHead";
        ...
        public override void AI()
        {
            ...
            if (timer < StartupTime + DashWindup)
            {
                ...
                Projectile.velocity = YharimEXGlobalUtilities.SmartAccel(Projectile.Center, desiredPos, Projectile.velocity, 2f, 2f);
            }
        ...
        {
            if (YharimEXWorldFlags.InfernumMode)
            {
                target.KillMe(PlayerDeathReason.ByCustomReason($"{target.name} was obliterated by the head of the Devourer of Gods."), 1000, 0, false);
            }
            else
            {
